...
/**
 * SecondaryNavbar component that changes based on current route
 * Displays different tab options depending on which page the user is on
 */
export default function SecondaryNavbar({ activeTab, setActiveTab }) {
  ...
  // If no activeTab is set, but we have items, default to the first item
