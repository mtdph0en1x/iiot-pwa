...
/**
 * Enhanced DataTable with pagination and scroll capabilities
 * 
 * @param {Object} props
 * @param {Array} props.columns - Array of column definitions with header, accessor, and optional render function
 * @param {Array} props.data - Array of data objects
 * @param {Function} props.actions - Optional function to render action buttons per row
 * @param {string} props.height - Height of the table body (e.g., "400px", "50vh")
 * @param {boolean} props.isLoading - Whether the table is loading data
 */
    ...
    <div className="overflow-hidden border border-gray-200 rounded-lg">
      ...
      <div className="bg-gray-50 p-3 border-t border-gray-200 flex justify-between items-center">
        ...
        <div className="flex space-x-1">
          {/* Show only a subset of page numbers when there are many pages */}
          ...
          {/* If not showing all pages, display last page with separator */}
